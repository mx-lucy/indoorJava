...
public class Centroid implements Dealer{
    ...
    public int getLocation(int s){
//        Optional<envFactors> envFactorsTemp;
//        envFactorsTemp = ThreePointFixService.list3(0);
//        for(envFactors : envFactorsTemp) {
//            envFactors.put(envFactorsTemp.getInt(1));
//        }
//        Optional<envFactors> env = envFactorsTemp;
        return s;
    };
